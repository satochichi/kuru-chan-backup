...
from Class.ContentFeatureListTag import ContentFeatureListTag
import time
...
maxPageCount =11
maxContentCount = 10
paging = Paging("blog/category/features/page/", maxPageCount, maxContentCount)
pageLinks = paging.getPageLinks()
capture = Capture("features", driver)
contentListTag = ContentFeatureListTag(driver)
print(pageLinks)
