...
from Class.ContentUsefulListTag import ContentUsefulListTag
import time
...
maxPageCount = 3
maxContentCount = 10
paging = Paging("blog/category/useful/page/", maxPageCount, maxContentCount)
pageLinks = paging.getPageLinks()
capture = Capture("useful", driver)
contentListTag = ContentUsefulListTag(driver)
print(pageLinks)
